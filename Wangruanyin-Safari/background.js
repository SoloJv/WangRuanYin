// Wangruanyin background page (Safari Web Extension API: browser.*).
...
browser.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (message.type === "TRANSLATE_TEXT") {
    ...
    translateWithGoogle(message.text, targetLang)
      .then((t) => sendResponse({ ok: true, translation: t }))
      .catch(() => sendResponse({ ok: true, translation: "" }));
